...
const Link: React.FC<LinkProps> = ({ href, children, className, onClick, target, rel }) => (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <p className="text-lg text-gray-400 max-w-xl leading-relaxed">
              The fastest automated minting infrastructure. Zero latency. Institutional-grade security. Stop competing.
              Start dominating.
            </p>
      ...
      <section className="relative z-10 py-24 border-t border-white/5 bg-gradient-to-b from-[#02040a] to-blue-950/20">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            NFTPulse is currently in <strong>Closed Beta</strong>. Access is merit-based: earned by active contribution in
            our Discord or via application.
            <br />
            <br />
            <span className="text-blue-400 font-semibold">Genesis Pass (Lifetime Access)</span> mint coming soon for V1
            launch.
          </p>
