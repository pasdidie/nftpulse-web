      ...
      <section className="relative z-10 pt-36 pb-16 px-6 max-w-7xl mx-auto min-h-[calc(100vh-3.5rem)]  flex flex-col justify-center">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="animate-slide-in-left">
            ...
            <p className="text-sm text-gray-500 mb-8">
              Built for WL and public mint wars. Average routing latency under 10ms across 6 EVM chains.
            </p>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
          {[
            ...
            { value: 6, suffix: '', label: 'EVM Chains', prefix: '' },
        ...
        <div className="mt-10 flex flex-col items-center gap-3 animate-fade-in-up" style={{ animationDelay: '600ms' }}>
          ...
          <div className="flex items-center gap-5">
            {[
              ...
              { logo: <ApeChainLogo />, name: 'ApeChain' },
              { logo: <AnimeChainLogo />, name: 'AnimeChain' },
            ].map((chain, i) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Carousel>
            <FeatureTile
              ...
              metric="5"
              metricLabel="Chains — ETH, Base, MegaETH, Abstract, ApeChain, AnimeChain"
            />
            <FeatureTile
              icon={Zap}
              title="Mint Engine"
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.015] px-7">
            ...
            <FAQItem
              ...
              answer="Any ERC-721 or ERC-1155 mint on supported EVM chains (Ethereum, Base, MegaETH, Abstract, ApeChain, AnimeChain). The system auto-detects contract parameters including mint price, supply, and function selectors."
            />
            <FAQItem
