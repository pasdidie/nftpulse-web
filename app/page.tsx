...
// On définit une interface pour les props du composant Link.
// Cela dit à TypeScript : "Voici exactement les données que ce composant va recevoir".
...
// On applique l'interface ": CustomLinkProps" aux props du composant.
